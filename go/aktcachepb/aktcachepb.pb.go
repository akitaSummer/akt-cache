...
func init() {
	proto.RegisterType((*Request)(nil), "aktcachepb.Request")
	proto.RegisterType((*Response)(nil), "aktcachepb.Response")
}

func init() { proto.RegisterFile("aktcachepb.proto", fileDescriptor_889d0a4ad37a0d42) }
